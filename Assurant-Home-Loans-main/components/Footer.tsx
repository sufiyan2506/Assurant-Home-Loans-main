...
const Footer: React.FC<FooterProps> = ({ onOpenInquiry }) => {
  return (
    <motion.footer 
      ...
      className="bg-navy-900 text-white pt-24 pb-12 rounded-t-[2.5rem] md:rounded-t-[4rem] relative z-20 overflow-hidden shadow-2xl"
    >
      <div className="container mx-auto px-6 lg:px-10">
        {/* Top section: Brand + CTA */}
        <div className="flex flex-col md:flex-row md:items-start justify-between gap-10 mb-16">
          <div className="max-w-sm">
            <img src="/assurant-logo.svg" alt="Assurant Home Loans" className="h-10 lg:h-12 w-auto object-contain brightness-0 invert mb-6" />
            ...
            <p className="text-gray-500 text-[10px] uppercase tracking-widest font-semibold mb-6">
              NMLS #1767773
            </p>
            <div className="flex gap-3">
              <a href="#" aria-label="Facebook" className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center hover:bg-brand-600 transition-colors"><Facebook size={18} /></a>
              <a href="#" aria-label="Instagram" className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center hover:bg-brand-600 transition-colors"><Instagram size={18} /></a>
              <a href="#" aria-label="LinkedIn" className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center hover:bg-brand-600 transition-colors"><Linkedin size={18} /></a>
            </div>
          </div>

          <div className="bg-white/5 p-8 rounded-[1.5rem] border border-white/5 md:max-w-xs w-full">
            <h4 className="font-serif text-2xl mb-3">Ready to apply?</h4>
            <p className="text-sm text-gray-400 mb-6">Get pre-qualified in minutes. No credit impact.</p>
            <button onClick={onOpenInquiry} className="w-full py-4 bg-brand-500 text-white font-semibold text-xs uppercase tracking-widest hover:bg-white hover:text-brand-600 transition-all rounded-full shadow-lg shadow-brand-500/15 active:scale-[0.98]">
              Apply now
            </button>
          </div>
        </div>
        ...
        {/* Link Columns */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-x-12 gap-y-12 mb-16">
          {/* Loan Programs */}
          <div>
            <h4 className="font-semibold text-sm uppercase tracking-widest mb-6 text-brand-400">Loan programs</h4>
          ...
          {/* Products */}
          <div>
            <h4 className="font-semibold text-sm uppercase tracking-widest mb-6 text-brand-400">Products</h4>
            <ul className="space-y-3.5 text-gray-400 text-sm">
          ...
          {/* Contact */}
          <div>
            <h4 className="font-semibold text-sm uppercase tracking-widest mb-6 text-brand-400">Contact</h4>
            <ul className="space-y-5 text-gray-400">
              <li className="flex items-start gap-3">
                <MapPin size={16} className="text-brand-400 mt-0.5 shrink-0" />
                <span className="text-sm">1212 Corporate Dr #117<br/>Irving, Texas 75038</span>
              </li>
              <li className="flex items-center gap-3">
                <Phone size={16} className="text-brand-400 shrink-0" />
                <a href="tel:9402069406" className="text-sm hover:text-white transition-colors">940-206-9406</a>
              </li>
              <li className="flex items-center gap-3">
                <Mail size={16} className="text-brand-400 shrink-0" />
                <a href="mailto:sunil@assuranthomeloans.com" className="text-sm break-all hover:text-white transition-colors">sunil@assuranthomeloans.com</a>
              </li>
            </ul>
          ...
          {/* Legal */}
          <div>
            <h4 className="font-semibold text-sm uppercase tracking-widest mb-6 text-brand-400">Legal</h4>
            <ul className="space-y-3.5 text-gray-400 text-sm">
              <li><Link to="/legal/privacy-policy" className="hover:text-white transition-colors">Privacy policy</Link></li>
              <li><Link to="/legal/accessibility" className="hover:text-white transition-colors">Accessibility</Link></li>
              <li><Link to="/legal/licensing" className="hover:text-white transition-colors">Licensing</Link></li>
              <li><Link to="/legal/texas-sml-notice" className="hover:text-white transition-colors">Texas SML notice</Link></li>
            </ul>
          </div>
        </div>
